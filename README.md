...
<p align="center">
  ...
  <a href="https://api.goldhoang.dev">
    <img src="https://img.shields.io/badge/API-api.goldhoang.dev-111827?style=for-the-badge&logo=fastapi&logoColor=white" alt="API" />
  </a>
</p>
...
### 1) GoldHoang Personal Platform
Production-ready platform built with **.NET 8**, **Next.js**, **Clerk Auth**, and **Gemini AI**.

### 2) AI-Powered SmartHome System
IoT ecosystem integrating **Hangfire**, **AWS Rekognition**, **STM32**, and **Jetson Nano**.

### 3) Clinic Booking System
Medical appointment platform powered by **Next.js**, **Prisma**, and **Supabase**.
